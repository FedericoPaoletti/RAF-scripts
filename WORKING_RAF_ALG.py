...
#random.seed("Federico seed2733") #Uncomment this in order to obtain a fixed series of random numbers! Useful for debugging.
...
def irrRAFsample(RAFset): #ASK ALEX POPINGA IF SHE CAN GET THIS SAMPLING ALGORITHM TO WORK!!!
	...
	#current_RPlist = [element[1] for element in RAFset]
		...
		if reaction in RAFset: #ADDED THIS LINEEE!!!
			...
			reduced_RAF = RAF_algorithm(food, reaction_products, reaction_products2, RAFset) 
...
myRAF = RAF_algorithm(food, RPlist, RPlist_2, catalysations)

#irrRAFsample(myRAF)

if myRAF:
	numberedRAF = Retrieve_RAF_reactionNum(myRAF, RPlist_2) 
